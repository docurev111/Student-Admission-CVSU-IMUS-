    ...
    <div class="grid-container">
        ...
        <header class="header">
            ...
            <div class="header-right">
                <a href="Login.html"><i class="ri-logout-box-r-line" style="text-decoration: none;"></i></a>
            </div>
        </header>
        <!-- End Header -->
        <!-- Sidebar -->
        <aside id="sidebar">
            <div class="sidebar-title">
                <div class="sidebar-brand">
                    <img src="./images/cvsulogo.png" alt="" width="120px" height="100px">
                </div>
            ...
            <ul class="sidebar-list">
                ...
                <li class="sidebar-list-items">
                    <a href="#"><i class="ri-booklet-line"><span>Notice</span></i></a>
                </li>
            </ul>
        </aside>
        <!-- End Sidebar -->
                ...
                <div class="main">
                    ...
                    <div class="status">
                        <div class="status-info">
                            <p>May 28, 2024</p>
                            <h2>Status: <span>Enrolled</span></h2>
                            <h3>Welcome back, </h3>
                            <p>Always stay updated in your student portal</p>
                        </div>
                        <div class="profile">
                            <img src="./images/daben.png" alt="Profile Picture">
...
<script>
        // Example to fetch user ID from session and update dashboard content
        fetch('get_username.php')
            .then(response => response.json())
            .then(data => {
                const studentId = data.student_id;
                // Use the student ID to personalize dashboard content (e.g., fetch user details)
            })
